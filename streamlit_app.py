...
# ========= PAGE CONFIG =========
# Phải đặt ở đầu file, trước bất kỳ lệnh Streamlit nào khác
st.set_page_config(
    page_title="Trợ Lý A.I Cá Nhân Hóa",
    page_icon="🤖",
    layout="centered",
    ...
    menu_items={
        'Get Help': None,
        'Report a bug': None,
        'About': "# Trợ Lý A.I Cá Nhân Hóa\nỨng dụng Trợ Lý AI thông minh, hỗ trợ bạn trong công việc và cuộc sống hàng ngày"
    }
)
...
# ========= MAIN =========
def main():
    # Inject metadata vào HTML head bằng component HTML
    # Component này sẽ inject metadata trực tiếp vào head tag
    components.html("""
    <script>
        (function() {
            // Đảm bảo chạy ngay khi load
            ...
            title.textContent = 'Trợ Lý A.I Cá Nhân Hóa';
            
            // Metadata tags
            const metas = [
                { tag: 'meta', attr: 'property', value: 'og:title', content: 'Trợ Lý A.I Cá Nhân Hóa' },
                { tag: 'meta', attr: 'property', value: 'og:description', content: 'Ứng dụng Trợ Lý AI thông minh, hỗ trợ bạn trong công việc và cuộc sống hàng ngày' },
                { tag: 'meta', attr: 'property', value: 'og:image', content: 'https://tm1.anhlaptrinh.vn/logo.png' },
                { tag: 'meta', attr: 'property', value: 'og:url', content: 'https://tm1.anhlaptrinh.vn/' },
                { tag: 'meta', attr: 'property', value: 'og:type', content: 'website' },
                { tag: 'meta', attr: 'property', value: 'og:site_name', content: 'Trợ Lý AI' },
                { tag: 'meta', attr: 'name', value: 'twitter:card', content: 'summary_large_image' },
                { tag: 'meta', attr: 'name', value: 'twitter:title', content: 'Trợ Lý A.I Cá Nhân Hóa' },
                { tag: 'meta', attr: 'name', value: 'twitter:description', content: 'Ứng dụng Trợ Lý AI thông minh, hỗ trợ bạn trong công việc và cuộc sống hàng ngày' },
                { tag: 'meta', attr: 'name', value: 'twitter:image', content: 'https://tm1.anhlaptrinh.vn/logo.png' },
                { tag: 'meta', attr: 'name', value: 'description', content: 'Ứng dụng Trợ Lý AI thông minh, hỗ trợ bạn trong công việc và cuộc sống hàng ngày' }
            ];
            ...
            metas.forEach(meta => {
                ...
                if (!element) {
                    ...
                    element.setAttribute(meta.attr, meta.value);
